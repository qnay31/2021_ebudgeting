...
<body class="bg-gradient-light">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="" method="post" onsubmit="return validasi_input2(this)" autocomplete="off"
                                ...
                                <div class="form-group">
                                    <select class="custom-select form-control form-control-select" name="divisi"
                                        id="divisi">
                                        <option selected disabled>-Pilih Salah Satu Divisi</option>
                                        <?php
    ...
    <script type="text/javascript" src="js/validasi_masuk.js"></script>
