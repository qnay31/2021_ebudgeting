                        ...
                        <tr>
                            ...
                            <td style=" text-align: center;">
                                <a class="btn btn-success"
                                    href="<?= $_SESSION["username"] ?>.php?id_input=laporan_logistik&id_management=aset&id_unik3=<?= $r['id'] ?>&id_p3=<?= $bln ?>"
                            ...
                            <td style=" text-align: center;"><a class="btn btn-primary"
                                    href="../user/<?= $_SESSION["username"] ?>.php?id_edit=edit_aset&id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                                    onclick="return confirm('Yakin anggaran ini mau diedit?!')">Edit</a> | <a
                                    class="btn btn-danger"
                                    href="../content/hapus/hapus_aset.php?id=verifikasi_logistik&id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
