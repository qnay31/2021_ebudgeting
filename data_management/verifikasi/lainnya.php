        ...
        <div class="tab-pane fade show active" id="nav-global" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <div class="table-responsive">
                <div class="text-center">
                    <label for=""><b style="color: black;">Anggaran Lainnya</b>
                        <hr>
                    </label>
                </div>
                        ...
                        <tr>
                            ...
                            <td style=" text-align: center;">
                                <a class="btn btn-success"
                                    href="<?= $_SESSION["username"] ?>.php?id_input=laporan_logistik&id_management=lainnya&id_unik5=<?= $r['id'] ?>&id_p5=<?= $bln ?>"
                                    onclick="return confirm('Semua tugas selesai, siap laporkan !!')">Laporan</a>
                            </td>
                            <?php } else { ?>
                            <td style=" text-align: center;"><a class="btn btn-primary"
                                    href="../user/<?= $_SESSION["username"] ?>.php?id_edit=edit_lainnya&id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                            ...
                            <td style=" text-align: center;"><a class="btn btn-danger"
                                    href="../content/hapus/hapus_lainnya.php?id=verifikasi_logistik&id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
