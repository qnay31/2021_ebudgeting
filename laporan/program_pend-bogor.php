<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM program WHERE laporan = 'Terverifikasi' AND cabang = 'Bogor' AND id_pengurus = 'program_pendidikan' AND status = 'OK' ORDER BY `tgl_pemakaian` DESC");
?>
<div id="nav-program">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a class="nav-link" id="nav-profile-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=database_program&id_program=program_bogor" role="tab"
                aria-controls="nav-profile" aria-selected="false">Global</a>
            <a class="nav-link" id="nav-contact-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=database_program&id_program=kes_bogor" role="tab"
                aria-controls="nav-contact" aria-selected="false">Kes Bogor</a>

            <a class="nav-link active" id="nav-contact-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=database_program&id_program=pend_bogor" role="tab"
                aria-controls="nav-contact" aria-selected="false">Pend Bogor</a>
