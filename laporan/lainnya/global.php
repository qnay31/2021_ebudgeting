<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM data_lainnya ORDER BY `id` ASC");
?>
<div id="nav-program">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-link active" id="nav-home-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=global_lainnya" role="tab" aria-controls="nav-home"
        ...
        <div class="tab-pane fade show active" id="nav-global" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <div class="table-responsive">
                <div class="text-center">
                    <label for=""><b style="color: black;">Tabel Biaya lainnya Global 2021</b>
                        <hr>
                    </label>
                </div>
                <table id="tabel-data_aset_global" class="table table-striped table-bordered nowrap">
                    <thead>
                        <tr style="text-align: center;">
                            ...
                            <th scope="col">Biaya Lainnya Anggaran Global</th>
                            <th scope="col">Biaya Lainnya Terpakai Global</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
