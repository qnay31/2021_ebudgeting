<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM program WHERE laporan = 'Terverifikasi' AND cabang = 'Depok' AND id_pengurus = 'program_pendidikan' AND status = 'OK' ORDER BY `tgl_pemakaian` DESC");
?>
<div id="nav-program">
    <nav>
