<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM logistik WHERE laporan = 'Terverifikasi' AND status = 'OK' ORDER BY `tgl_pemakaian` DESC");
?>
<div id="nav-program">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-link active" id="nav-home-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=global_logistik" role="tab" aria-controls="nav-home"
