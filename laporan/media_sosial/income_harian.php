<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM income WHERE status = 'Terverifikasi' ORDER BY `tgl_pemasukan` DESC");
?>
<div id="nav-program">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-link active" id="nav-home-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=harian_media" role="tab" aria-controls="nav-home"
        ...
        <div class="tab-pane fade show active" id="nav-global" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <div class="table-responsive">
                <table id="tabel-data_harian_income" class="table table-striped table-bordered nowrap">
                    <p style="text-align: center;"><b>Pemasukan Global Harian</b></p>
                    <thead>
