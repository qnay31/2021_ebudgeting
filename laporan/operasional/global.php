<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM data_operasional_yayasan ORDER BY `id` ASC");
?>
<div id="nav-program">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-link active" id="nav-home-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=global_operasional" role="tab"
                aria-controls="nav-home" aria-selected="true">Global</a>

            <a class="nav-link" id="nav-profile-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=global_operasional&id_operasional=rincian" role="tab"
        ...
        <div class="tab-pane fade show active" id="nav-global" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <div class="table-responsive">
                <div class="text-center">
                    <label for=""><b style="color: black;">Tabel Operasional Yayasan Global 2021</b>
                        <hr>
                    </label>
                </div>
                <table id="tabel-data_aset_global" class="table table-striped table-bordered nowrap">
                    <thead>
                        <tr style="text-align: center;">
                            ...
                            <th scope="col">Operasional Anggaran Global</th>
                            <th scope="col">Operasional Terpakai Global</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
