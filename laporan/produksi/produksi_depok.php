<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM produksi WHERE laporan = 'Terverifikasi' AND cabang = 'Depok' ORDER BY `tgl_pemakaian` DESC");
?>
<div id="nav-program">
    <nav>
        ...
        <div class="tab-pane fade show active" id="nav-global" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <div class="table-responsive">
                <div class="text-center">
                    <label for=""><b style="color: black;">Tabel Rincian Produksi Depok 2021</b>
                        <hr>
                    </label>
                </div>
