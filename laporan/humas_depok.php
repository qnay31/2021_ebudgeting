<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM humas WHERE laporan = 'Terverifikasi' AND cabang = 'Depok' AND status = 'OK' ORDER BY `tgl_pemakaian` DESC");
?>
<div id="nav-program">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a class="nav-link active" id="nav-profile-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=global_humas" role="tab" aria-controls="nav-profile"
                aria-selected="false">Depok</a>
            <?php } else { ?>
            <a class="nav-link active" id="nav-profile-tab"
                href="<?= $_SESSION["username"] ?>.php?id_database=global_humas" role="tab" aria-controls="nav-profile"
                aria-selected="false">Depok</a>
