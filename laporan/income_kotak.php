<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM pemasukan WHERE kategori = 'kotak amal' AND status = 'Terverifikasi' ORDER BY `tgl_ambil` DESC");
?>
<div id="nav-program">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-link" id="nav-home-tab" href="<?= $_SESSION["username"] ?>.php?id_database=database_income"
