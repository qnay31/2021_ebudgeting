<?php
// global
$q  = mysqli_query($conn, "SELECT * FROM aset_yayasan WHERE laporan = 'Terverifikasi' ORDER BY `tgl_laporan` DESC");
?>
<div id="nav-program">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-link" id="nav-home-tab" href="<?= $_SESSION["username"] ?>.php?id_database=global_aset"
        ...
        <div class="tab-pane fade show active" id="nav-global" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <div class="table-responsive">
                <div class="text-center">
                    <label for=""><b style="color: black;">Tabel Rincian Aset Yayasan 2021</b>
                        <hr>
                    </label>
                </div>
                <table id="tabel-data_aset_verif" class="table table-striped table-bordered nowrap">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?= $r['qty_pembelian'] ?></td>
