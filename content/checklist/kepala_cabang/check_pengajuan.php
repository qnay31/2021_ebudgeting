...
// humas
$q3  = mysqli_query($conn, "SELECT * FROM humas WHERE laporan = 'Belum Laporan' AND cabang = '$_SESSION[cabang]' AND status_b = 'Pending' ORDER BY `tgl_pengajuan` DESC");

$s3 = $q3->num_rows;

// notif
// program
$n  = mysqli_query($conn, "SELECT * FROM program WHERE laporan = 'Belum Laporan' AND cabang = '$_SESSION[cabang]' AND status = 'OK' ORDER BY `tgl_pengajuan` DESC");

$a = $n->num_rows;

// logistik
$n2  = mysqli_query($conn, "SELECT * FROM logistik WHERE laporan = 'Belum Laporan' AND cabang = '$_SESSION[cabang]' AND status = 'OK' ORDER BY `tgl_pengajuan` DESC");

$a2 = $n2->num_rows;

// humas
$n3  = mysqli_query($conn, "SELECT * FROM humas WHERE laporan = 'Belum Laporan' AND cabang = '$_SESSION[cabang]' AND status = 'OK' ORDER BY `tgl_pengajuan` DESC");

$a3 = $n3->num_rows;

// laporan notif
// program
$n4 = mysqli_query($conn, "SELECT * FROM program WHERE laporan = 'Menunggu Konfirmasi' AND cabang = '$_SESSION[cabang]' AND status = 'OK' ORDER BY `tgl_pengajuan` DESC");

$a4 = $n4->num_rows;

// logistik
$n5  = mysqli_query($conn, "SELECT * FROM logistik WHERE laporan = 'Menunggu Konfirmasi' AND cabang = '$_SESSION[cabang]' AND status = 'OK' ORDER BY `tgl_pengajuan` DESC");

$a5 = $n5->num_rows;

// humas
$n6  = mysqli_query($conn, "SELECT * FROM humas WHERE laporan = 'Menunggu Konfirmasi' AND cabang = '$_SESSION[cabang]' AND status = 'OK' ORDER BY `tgl_pengajuan` DESC");
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center" id="page">
                <ul class="pagination shadow-lg">
                    <li class="page-item active"><a class="page-link"
                            href="<?= $_SESSION["username"] ?>.php?id_check=check_cabang"> <small
                    ...
                    <li class="page-item"><a class="page-link"
                            href="<?= $_SESSION["username"] ?>.php?id_check=cabang_laporan"><small>Laporan
                                &nbsp;</small>
                            <?php if($a4+$a5+$a6 == 0){ ?>
                            <?php }else { ?>
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;"><a class="btn btn-primary"
                                            href="../user/<?= $_SESSION["username"] ?>.php?id_edit=edit_program&id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                                            onclick="return confirm('Yakin anggaran ini mau diedit?!')">Edit</a>
                                    </td>
                                    <td style=" text-align: center;"><a class="btn btn-success"
                                            href="../admin/verif_anggaran_program.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                        ...
                        <table id="tabel-data_verifikasi2" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $bln3       = substr($r['tgl_pengajuan'], 5,-3);
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?= ucwords($r['status_b']) ?></td>
                                    <td style=" text-align: center;"><a class="btn btn-success"
                                            href="../admin/verif_anggaran_logistik.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln3 ?>"
                                            onclick="return confirm('Anggaran untuk diproses !!')">Konfirmasi</a>
                                    </td>
                                    <td>Rp. <?= number_format($r['dana_anggaran'],0,"." , ".") ?></td>
                                </tr>
                        ...
                        <table id="tabel-data_verifikasi3" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= ucwords($r['deskripsi']) ?></td>
                                    <td style=" text-align: center;"><a class="btn btn-success"
                                            href="../admin/verif_anggaran_baksos_pusat.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln3 ?>"
                                            onclick="return confirm('Anggaran untuk diproses !!')">Konfirmasi</a>
                                    </td>
                                    <td>Rp. <?= number_format($r['dana_anggaran'],0,"." , ".") ?></td>
                                </tr>
