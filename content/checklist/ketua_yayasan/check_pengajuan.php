...
// program
$q  = mysqli_query($conn, "SELECT * FROM program WHERE laporan = 'Belum Laporan' AND status_b = 'OK' AND status = 'Pending' ORDER BY `tgl_pengajuan` DESC");

$s = $q->num_rows;

// baksos
$q2  = mysqli_query($conn, "SELECT * FROM baksos WHERE laporan = 'Belum Laporan' AND status = 'Pending' ORDER BY `tgl_pengajuan` DESC");

$s2 = $q2->num_rows;

// logistik
$q3  = mysqli_query($conn, "SELECT * FROM logistik WHERE laporan = 'Belum Laporan' AND status_b = 'OK' AND status = 'Pending' ORDER BY `tgl_pengajuan` DESC");

$s3 = $q3->num_rows;

// humas
$q4  = mysqli_query($conn, "SELECT * FROM humas WHERE laporan = 'Belum Laporan' AND status_b = 'OK' AND status = 'Pending' ORDER BY `tgl_pengajuan` DESC");
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center" id="page">
                <ul class="pagination shadow-lg">
                    <li class="page-item active"><a class="page-link"
                            href="<?= $_SESSION["username"] ?>.php?id_check=check_global"> <small
                                class="text-white">RAB&nbsp;</small>
                            <?php if($s+$s2+$s3+$s4 == 0){ ?>
                            <?php }else { ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;"><a class="btn btn-success"
                                            href="../admin/verif_anggaran_program_pusat.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                        ...
                        <table id="tabel-data_verifikasi3" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?= ucwords($r['status_b']) ?></td>
                                    <td style=" text-align: center;"><a class="btn btn-success"
                                            href="../admin/verif_anggaran_logistik_pusat.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln3 ?>"
                                            onclick="return confirm('Anggaran untuk diproses !!')">Konfirmasi</a>
                                    </td>
                                    <td>Rp. <?= number_format($r['dana_anggaran'],0,"." , ".") ?></td>
                                </tr>
                        ...
                        <table id="tabel-data_verifikasi4" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?= ucwords($r['status_b']) ?></td>
                                    <td style=" text-align: center;"><a class="btn btn-success"
                                            href="../admin/verif_anggaran_humas_pusat.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln3 ?>"
                                            onclick="return confirm('Anggaran untuk diproses !!')">Konfirmasi</a>
                                    </td>
                                    <td>Rp. <?= number_format($r['dana_anggaran'],0,"." , ".") ?></td>
                                </tr>
