    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center" id="page">
                <ul class="pagination shadow-lg">
                    ...
                    <li class="page-item active"><a class="page-link "
                            href="<?= $_SESSION["username"] ?>.php?id_pemasukan=check_income"></i><small
            ...
            <div class="card shadow">
                <div class="card-body">
                    <label for=""><b>Checklist Income Media Sosial :</b>
                        <hr>
                    </label>
                    <div class="table-responsive">
                        ...
                        <div class="text-center">
                            <label for=""><b style="color: black;">Income Media Sosial</b>
                                <hr>
                            </label>
                        </div>
                        <table id="tabel-data_media" class="table table-bordered">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;"><a class="btn btn-success"
                                            href="../admin/verif_income.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                                            onclick="return confirm('Konfirmasi <?= ucwords($r['kategori']) ?> gedung <?= ucwords($r['gedung']) ?>?!')">Konfirmsi</a>
                                    </td>
