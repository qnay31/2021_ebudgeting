    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center" id="page">
                <ul class="pagination shadow-lg">
                    <li class="page-item active"><a class="page-link "
                            href="<?= $_SESSION["username"] ?>.php?id_pengeluaran=<?= $key ?>"></i><small
                                class="text-white">Pengeluaran&nbsp;</small>
            ...
            <div class="card shadow">
                <div class="card-body">
                    <label for=""><b>Checklist Pengeluaran :</b>
                        <hr>
                    </label>
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;">
                                        <a class="btn btn-success"
                                            href="../admin/verif_anggaran_gaji.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                        ...
                        <table id="tabel-data_aset" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;">
                                        <a class="btn btn-success"
                                            href="../admin/verif_anggaran_aset.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                                            onclick="return confirm('Anggaran untuk diproses !!')">Konfirmasi</a>
                                    </td>
                        ...
                        <table id="tabel-data_produksi" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;">
                                        <a class="btn btn-success"
                                            href="../admin/verif_anggaran_produksi.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                                            onclick="return confirm('Anggaran untuk diproses !!')">Konfirmasi</a>
                                    </td>
                                    <td>Rp. <?= number_format($r['dana_anggaran'],0,"." , ".") ?></td>
                                </tr>
                        ...
                        <table id="tabel-data_verifikasi" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;">
                                        <a class="btn btn-success"
                                            href="../admin/verif_anggaran_maintenance.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                                            onclick="return confirm('Anggaran untuk diproses !!')">Konfirmasi</a>
                                    </td>
                                    <td>Rp. <?= number_format($r['dana_anggaran'],0,"." , ".") ?></td>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;">
                                        ...
                                        <a class="btn btn-success"
                                            href="../admin/verif_anggaran_operasional.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                                            onclick="return confirm('Anggaran untuk diproses !!')">Konfirmasi</a>
                                        <?php } else { ?>
                                        <a class="btn btn-success"
                                            href="../admin/verif_anggaran_lainnya.php?id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                                            onclick="return confirm('Anggaran untuk diproses !!')">Konfirmasi</a>
                                        <?php } ?>
                                    </td>
                                    <td>Rp. <?= number_format($r['dana_anggaran'],0,"." , ".") ?></td>
