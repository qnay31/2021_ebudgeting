...
if (isset($_POST["input_operasional"]) ) {
    ...
    if(edit_laporan_operasional($_POST) > 0 ) {
        echo "<script>
                alert('Data Laporan Berhasil Diedit');
                document.location.href = '$link.php?id_taman=$linkid_taman&id_input=laporan_logistik&id_management=operasional';
            </script>";
...
<div class="container-fluid">
    ...
    <div class="col-xl-12 col-lg-12">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center" id="page">
            <ul class="pagination shadow-lg">
                <li class="page-item active"><a class="page-link"
                        href="<?= $_SESSION["username"] ?>.php?id_taman=<?= $linkid_taman ?>&id_edit=edit_laporan_operasional&id_unik=<?= $unik ?>&id_p=<?= $periode ?>">
        ...
        <div class="card shadow">
            <div class="card-body">
                <label for=""><b>Edit Laporan Operasional</b>
                    <hr>
                </label>
                <form action="" method="post" onsubmit="return validasi_input2(this)">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="deskripsi_laporan"
                            placeholder="Contoh: Operasional Mobil" id="alpabet" value="<?= $deskripsi ?>"
                    ...
                    <div class="button">
                        <input type="submit" name="input_operasional" class="btn btn-primary w-100" value="Ubah Data">
                    </div>
                </form>
            </div>
        </div>
