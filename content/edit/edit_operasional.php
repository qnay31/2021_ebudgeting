        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center" id="page">
            <ul class="pagination shadow-lg">
                <li class="page-item active"><a class="page-link"
                        href="<?= $_SESSION["username"] ?>.php?id_taman=<?= $linkid_taman ?>&id_edit=edit_operasional&id_unik=<?= $unik ?>&id_p=<?= $periode ?>">
        ...
        <div class="card shadow">
            <div class="card-body">
                ...
                <form action="" method="post" onsubmit="return validasi_input(this)">
                    ...
                    <div class="mb-3">
                        <div id="disabledSelect" class="form-text mb-2">
                            Deskripsi Operasional <b>Edit</b>
                        </div>
                        <input type="text" class="form-control" name="deskripsi" placeholder="Contoh: operasional jalan"
