            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center" id="page">
                <ul class="pagination shadow-lg">
                    ...
                    <li class="page-item active"><a class="page-link "
                            href="../user/<?= $_SESSION["username"] ?>.php?id_input=verifikasi_program"></i><small
                    ...
                    <li class="page-item"><a class="page-link"
                            href="../user/<?= $_SESSION["username"] ?>.php?id_input=laporan_program"><small>Laporan&nbsp;</small>
                            <?php if($s2 == 0){ ?>
                            <?php }else { ?>
                                ...
                                <tr>
                                    ...
                                    <td style=" text-align: center;">
                                        <a class="btn btn-success"
                                            href="<?= $_SESSION["username"] ?>.php?id_input=laporan_program&id_unik=<?= $r['id'] ?>&id_p=<?= $bln ?>"
                                    ...
                                    <?php } elseif ($r['id_pengurus'] == "kepala_program") { ?>
                                    <td style=" text-align: center;" class="disabled">
                                        -
                                    </td>

                                    <?php } elseif ($r['id_pengurus'] == "kepala_cabang") { ?>
                                    <td style=" text-align: center;" class="disabled">
                                        -
                                    </td>
                                    <?php } else { ?>
