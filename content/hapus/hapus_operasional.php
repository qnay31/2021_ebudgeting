...
// die(var_dump($hapus));
$query2 = mysqli_query($conn, "DELETE FROM `operasional_yayasan` WHERE id = '$unik' AND kategori = '$kategori' AND MONTH(tgl_dibuat) = '$periode' ");
...
document.location.href = '../../user/$_SESSION[username].php?id_taman=operasional_yayasan&id_input=verifikasi_logistik';
</script>";
}  else {
echo "<script>
