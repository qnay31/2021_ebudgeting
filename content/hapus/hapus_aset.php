...
// die(var_dump($hapus));
$query2 = mysqli_query($conn, "DELETE FROM `aset_yayasan` WHERE id = '$unik' AND kategori = '$kategori' AND MONTH(tgl_dibuat) = '$periode' ");
...
document.location.href = '../../user/$_SESSION[username].php?id_input=verifikasi_logistik&id_management=aset';
</script>";
}  else {
echo "<script>
