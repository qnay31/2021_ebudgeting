...
if (isset($_POST["input_program"]) ) {
    ...
    if(laporan_program($_POST) > 0 ) {
        echo "<script>
                ...
                document.location.href = '$link.php?id_input=laporan_program';
            </script>";
...
$query  = mysqli_query($conn, "SELECT * FROM program WHERE id = '$id' AND MONTH(tgl_pengajuan) = '$unik' ");
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center" id="page">
                <ul class="pagination shadow-lg">
                    <li class="page-item"><a class="page-link"
                            href="../user/<?= $_SESSION["username"] ?>.php?id_input=input_program">
                            <small>Pengajuan</small>
                        </a></li>
                    <li class="page-item"><a class="page-link "
                            href="../user/<?= $_SESSION["username"] ?>.php?id_input=verifikasi_program"></i><small>Verifikasi&nbsp;</small>
                            <?php if($s == 0){ ?>
                            <?php }else { ?>
                    ...
                    <li class="page-item active"><a class="page-link"
                            href="../user/<?= $_SESSION["username"] ?>.php?id_input=laporan_program&id_unik=<?= $id ?>&id_p=<?= $unik ?>">
                            <small class="text-white">Laporan&nbsp;</small>
                            <?php if($s2 == 0){ ?>
                            <?php }else { ?>
                    ...
                    <?php } else { ?>
                    <li class="page-item active"><a class="page-link"
                            href="../user/<?= $_SESSION["username"] ?>.php?id_input=laporan_program"><small
                        ...
                        <form action="" method="post" enctype="multipart/form-data"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="deskripsi_laporan"
                                    placeholder="santunan minggu ke iI" id="alpabet" style="text-transform: capitalize;"
                                    autocomplete="off">
                            ...
                            <div class="button">
                                <input type="submit" name="input_program" class="btn btn-primary w-100"
                                    value="Laporkan">
                            </div>
                        </form>
