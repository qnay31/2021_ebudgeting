...
$q = mysqli_query($conn, "SELECT akun_pengurus.id_pengurus, akun_pengurus.nama, akun_pengurus.cabang, akun_pengurus.profil, akun_pengurus.password, akun_pengurus.posisi, list_divisi.akses 
    FROM akun_pengurus
    JOIN list_divisi ON list_divisi.id_pengurus = akun_pengurus.id_pengurus WHERE list_divisi.akses = 'program' ORDER BY `nama` ASC ");
...
<div class="container">
    <div>
        <a class="btn btn-dafault filter-button" href="<?= $_SESSION["username"] ?>.php?id_data=pengurus">All</a>
